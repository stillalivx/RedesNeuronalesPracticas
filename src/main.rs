...
fn main() {
    ...
    // Indica el número de neuronas que contendrá cada patrón
    opts.optopt("n", "neurons", "Number of neurons", "NEURONS");
    // Indica el número de patrones de la red
    opts.optopt("p", "patterns", "Number of patterns", "PATTERNS");
    ...
    let n: usize = matches.opt_str("n")
        .expect("Number of neurons undefined")
        .trim()
        .parse()
        .expect("Number of neurons invalid");

    let m: usize = matches.opt_str("p")
        .expect("Number of patterns undefined")
        .trim()
        .parse()
        .expect("Number of patterns invalid");
